...
from PyQt5.QtWidgets import (
    ...
    QFrame, QHBoxLayout, QWidget, QMainWindow, QVBoxLayout, QLabel, QListWidgetItem
)
...
from ui.components.config.events import (event_reset_app, event_close_app, event_next_btn, event_back_btn)
