...
class LayoutFactory:
  ...
  def __init__(self, app_ref):
    ...
    self.pages_fact = app_ref.pages_fact
    
    #  setup page stack
    self.page_stack = QStackedWidget()
    self.page_1 = self.app_ref.pages_fact.create_page_1()
    self.page_2 = self.app_ref.pages_fact.create_page_2()
    self.page_3 = self.app_ref.pages_fact.create_page_3()
    self.page_4 = self.app_ref.pages_fact.create_page_4()
